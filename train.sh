...
singularity run /home/people/16304643/robochallenge/user_image.sif mpirun -np 8 python3 train.py --noisy-resets=1 --noise-level=1 --difficulty=3 --trajectory-aware=0 --ep-len=90 --steps-per-goal=30 --step-size=50 --z-reward=1 --z-scale=20 --xy-only=0 --simtoreal=1 --domain-randomization=0 --obs-type='default' --exp-dir='normalHERzrew' --n-epochs=300 2>&1 | tee normalHERzrew.log
